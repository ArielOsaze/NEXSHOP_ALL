...
function renderLeaderboard(data) {
    ...
    if (top3[1]) {
        ...
        <div class="flex flex-col items-center w-1/3 px-1 md:px-0 transform hover:-translate-y-2 transition-transform duration-300">
            <div class="hof-avatar hof-avatar--2 rounded-full p-1 mb-2 md:mb-4">
            ...
            <div class="hof-podium-card hof-podium-card--2 glass-panel w-full p-2 md:p-6 text-center border-t-4 border-slate-400 relative overflow-hidden group">
                <div class="absolute inset-0 bg-slate-500/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                ...
                ${top3[1].badge ? `<div class="inline-block px-1 md:px-2 py-0.5 rounded text-[8px] md:text-[10px] font-bold bg-slate-500/10 dark:bg-slate-300/15 text-slate-600 dark:text-slate-200 mb-1 md:mb-2 border border-slate-400/40 dark:border-slate-300/30 uppercase tracking-wider relative z-10">${escapeHtml(top3[1].badge)}</div>` : ''}
