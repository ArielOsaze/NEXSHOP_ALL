...
router.get("/admin/blocked-ips", authMiddleware, adminMiddleware, authController.listBlockedIps);
router.post("/admin/unlock-login", authMiddleware, adminMiddleware, authController.unlockLoginIp);
