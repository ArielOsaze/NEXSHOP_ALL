...
assert(/style\.css\?v=20260904-empty-avatar-template-1/.test(index), "homepage style cache-buster must be bumped");
assert(/script\.js\?v=20260904-empty-avatar-template-1/.test(index), "wallet script cache-buster must be bumped");
