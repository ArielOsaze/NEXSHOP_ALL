...
assert(/style\.css\?v=20260904-topup-mobile-single-column-1/.test(index), "homepage style cache-buster must be bumped");
assert(/20260904-mobile-card-avatar-template-2/.test(index), "wallet script cache-buster must be bumped");
