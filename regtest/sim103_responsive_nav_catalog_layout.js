...
assert(/style\.css\?v=20260904-mobile-card-avatar-template-2/.test(index), "homepage style cache-buster must be bumped");
assert(/script\.js\?v=20260904-mobile-card-avatar-template-2/.test(index), "wallet script cache-buster must be bumped");
