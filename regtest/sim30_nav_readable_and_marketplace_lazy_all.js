...
const { urutkanMarketplaceOperators } = require("../nexshop-backend/services/catalogIndexService");
...
assert.deepStrictEqual(sorted.map((item) => item.name), ["Alpha", "Bravo", "Delta", "Zeta"]);
