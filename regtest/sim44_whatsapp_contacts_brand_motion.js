...
assert.match(adminHtml, /data-view="waApi"/);
assert.match(adminHtml, /Kontak Terverifikasi/);
assert.match(adminHtml, /Sinkronkan ke WA API/);
assert.doesNotMatch(adminHtml, /sidebar-direct-contact/);
