...
assert(index.includes('style.css?v=20260829-visual-regression-2'), "CSS katalog baru wajib memakai cache-buster baru");
assert(index.includes('script.js?v=20260829-visual-regression-2'), "renderer katalog baru wajib memakai cache-buster baru");
