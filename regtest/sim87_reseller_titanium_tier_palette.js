...
assert(/style\.css\?v=20260904-empty-avatar-template-1/.test(homepage), "homepage must load the current cache-busted stylesheet");
assert(/script\.js\?v=20260904-empty-avatar-template-1/.test(homepage), "homepage must load the current avatar/account runtime");
