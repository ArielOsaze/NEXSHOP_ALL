...
assert(/rs-tier-card-silver[\s\S]*#(?:94a3b8|cbd5e1)/i.test(resellerCss), "Silver tier must use a silver frame palette");
assert(/rs-tier-card-gold[\s\S]*#(?:d97706|f59e0b|eab308)/i.test(resellerCss), "Gold tier must use a gold frame palette");
assert(/rs-tier-card-platinum[\s\S]*#(?:64748b|94a3b8|cbd5e1)/i.test(resellerCss), "Platinum tier must use a platinum frame palette");
